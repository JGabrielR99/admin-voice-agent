...
export function useImportProgress() {
  ...
  useEffect(() => {
    // Primero cargar el estado actual
    ...
    // Luego configurar el EventSource para actualizaciones en tiempo real
    ...
    try {
      ...
      eventSource.onerror = (e) => {
        ...
        eventSource.close();
        // Podemos implementar una lógica de reintento más sofisticada si es necesario
      };
    } catch (err) {
